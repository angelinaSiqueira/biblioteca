...
console.log(biblioteca.emprestarLivro(1, '321')); 
console.log(biblioteca.emprestarLivro(1, '567')); 
console.log(biblioteca.emprestarLivro(1, '432'));
console.log(biblioteca.listarLivrosDisponiveis());
console.log(biblioteca.devolverLivro(1, '987'));
console.log(biblioteca.listarLivrosDisponiveis());